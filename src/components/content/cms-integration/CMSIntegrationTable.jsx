...
import CMSIntegrationTableRow from "./CMSIntegrationTableRow";

export default function CMSIntegrationTable({
  headers,
  pages,
  selectedRows,
  handleSelectRow,
      ...
      <table className="min-w-full table-auto border-collapse">
        ...
        <tbody>
          {pages.map((page, index) => (
            <CMSIntegrationTableRow
              key={page.id}
              page={page}
              index={index}
              isSelected={selectedRows.includes(page.id)}
